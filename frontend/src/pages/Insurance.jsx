...
export default function Insurance() {
    ...
    useEffect(() => {
        setMeta(
            "Dubai Seyahat Sigortası | Dubai Vize Hattı",
            "Dubai seyahat sigortası zorunlu mu, neyi kapsar, kronik hastalıklar dahil mi? BAE genelinde geçerli poliçenin kapsamı, sınırları ve başvuruya nasıl eklendiği.",
