...
const FIELDS = [
    ...
    { key: "parent_company", label: "Bağlı olduğu şirket (satıcı)", placeholder: "Örn. Moruya Travel Solutions Turizm Ltd. Şti.", wide: true },
    { key: "dubai_company", label: "Dubai (BAE) şirketi", placeholder: "Örn. Moruya Travel Solutions FZE", wide: true },
    ...
    { key: "address", label: "Adres (İstanbul)", placeholder: "Mahalle, ilçe / il", wide: true },
    { key: "dubai_address", label: "Adres (Dubai / BAE)", placeholder: "Level 27, Unit 2705, Marina Plaza, Dubai Marina", wide: true },
    { key: "phone", label: "Telefon (İstanbul)", placeholder: "+90 ..." },
