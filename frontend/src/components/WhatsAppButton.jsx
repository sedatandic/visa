...
export const WhatsAppButton = () => (
    <a
        ...
        className="fixed bottom-5 right-5 z-50 flex h-14 items-center gap-2 rounded-full bg-[#25D366] px-4 text-white transition-transform duration-150 hover:-translate-y-0.5"
