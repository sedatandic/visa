...
function buildStaticPages(ctx) {
    ...
    return [
            ...
            sections: [
                ...
                },
                {
                    ...
                    list: [
                        ...
                        "Türkçe rehberli çöl safarisi turu (tarih ve saat seçimiyle)",
                    ],
                },
            ].filter(Boolean),
        ...
        },
        {
            ...
            priority: "0.6",
            changefreq: "monthly",
            title: `Dubai Turları ve Çöl Safarisi | ${BRAND}`,
            description:
                "Türkçe rehberli Dubai çöl safarisi: kumul turu, deve gezisi, kum sörfü ve Arap kampında akşam yemeği. Tarih ve saat seçip rezervasyon yapın.",
            h1: "Çöl safarisi ve Dubai aktiviteleri",
            intro: [
                "Türkçe konuşan rehber eşliğinde çöl safarisi turlarını tarih ve saat seçerek sepete ekleyin; rezervasyonunuzu biz yapar, kupon ve buluşma bilgilerini e-postanıza göndeririz.",
            ...
            sections: [
                {
                    ...
                    list: [
                        "4x4 araçlarla kum tepelerinde safari (dune bashing)",
                        "Deve gezisi ve çölde gün batımı molası",
                        "Kum sörfü (sandboarding) denemesi",
                        "Arap kampında açık büfe akşam yemeği ve canlı gösteriler",
                        "Otelden alış ve tur sonunda otele bırakış",
                    ],
                },
                {
